...
const items = [
  {
    ...
    description: "Transforming corporate gatherings into engaging experiences that build connections and boost morale.",
    header: <Skeleton color="from-blue-100 to-blue-50 dark:from-blue-900/40 dark:to-blue-900/10" />,
    icon: <Icons.Clipboard />,
  },
  {
    title: "Conference Leadership",
    description: "Hosting high-stakes summits and professional gatherings with precision and energy.",
    header: <Skeleton color="from-slate-100 to-slate-50 dark:from-slate-900/40 dark:to-slate-900/10" />,
    icon: <Icons.Globe />,
  },
  {
    title: "Awards & Galas",
    description: "Bringing energy and prestige to celebration nights with elegance.",
  ...
  },
  {
    ...
    description: "Turning passive crowds into active participants with interactive engagement.",
    header: <Skeleton color="from-purple-100 to-purple-50 dark:from-purple-900/40 dark:to-purple-900/10" />,
    icon: <Icons.Sparkles />,
  },
  {
    title: "Panel Moderation",
    description: "Facilitating insightful conversations with industry experts and thought leaders.",
