      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {services.map((service, idx) => (
          <div 
            ...
            className="bg-white dark:bg-brand-dark-surface rounded-2xl p-8 flex flex-col justify-between min-h-[240px] shadow-sm hover:shadow-xl hover:shadow-stone-200 dark:shadow-none dark:hover:shadow-gold-900/10 transition-all duration-300 group relative overflow-hidden border border-stone-100 dark:border-white/10 cursor-pointer hover:-translate-y-1"
          >
