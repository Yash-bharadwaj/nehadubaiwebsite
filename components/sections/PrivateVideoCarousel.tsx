...
// Import private event videos
import video1 from '../privatevidoes/privateEvent-1.mp4';
import video2 from '../privatevidoes/privateEvent-2.mp4';
import video3 from '../privatevidoes/privateEvent-3.mp4';
import video4 from '../privatevidoes/privateEvent-4.mp4';
import video5 from '../privatevidoes/privateEvent-5.mp4';

const videoSources = [
  video1, video2, video3, video4, video5
];

const categories = ['Private Event', 'Celebration', 'Gathering', 'Special Occasion', 'Intimate'];

const videos = videoSources.map((src, index) => ({
  id: index + 1,
  src: src,
  title: `Private Event ${index + 1}`,
  category: categories[index % categories.length],
}));

const PrivateVideoCarousel: React.FC = () => {
  ...
  return (
    <div className="py-12 bg-brand-primary dark:bg-brand-dark-bg transition-colors overflow-hidden border-b border-stone-200 dark:border-white/5">
...
export default PrivateVideoCarousel;
