...
// Import community videos
import video1 from '../communityVideos/communityEvent-1.mp4';
import video2 from '../communityVideos/communityEvent-2.mp4';
import video3 from '../communityVideos/communityEvent-3.mp4';
import video4 from '../communityVideos/communityEvent-4.mp4';
import video5 from '../communityVideos/communityEvent-5.mp4';

const videoSources = [
  video1, video2, video3, video4, video5
];

const categories = ['Community', 'Festival', 'Gathering', 'Celebration', 'Event'];
...
const CommunityVideoCarousel: React.FC = () => {
...
export default CommunityVideoCarousel;
