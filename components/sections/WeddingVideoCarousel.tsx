...
// Import wedding videos
import video1 from '../weddingVideos/weddings-1.mp4';
import video2 from '../weddingVideos/weddings-2.mp4';
import video3 from '../weddingVideos/weddings-3.mp4';
import video4 from '../weddingVideos/weddings-4.mp4';
import video5 from '../weddingVideos/weddings-5.mp4';

const videoSources = [
  video1, video2, video3, video4, video5
];

const categories = ['Wedding', 'Ceremony', 'Reception', 'Celebration', 'Sangeet'];

const videos = videoSources.map((src, index) => ({
  id: index + 1,
  src: src,
  title: `Wedding Event ${index + 1}`,
  category: categories[index % categories.length],
}));

const WeddingVideoCarousel: React.FC = () => {
...
export default WeddingVideoCarousel;
