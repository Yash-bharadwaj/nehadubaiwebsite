...
// Import corporate videos
import video1 from '../corperateVidoes/Corporate-1.mp4';
import video2 from '../corperateVidoes/corporate-2.mp4';
import video3 from '../corperateVidoes/corporate-3.mp4';
import video4 from '../corperateVidoes/corporate-4.mp4';
import video5 from '../corperateVidoes/corporate-5.mp4';

const videoSources = [
  video1, video2, video3, video4, video5
];

const categories = ['Corporate', 'Awards', 'Conferences', 'Team Building', 'Events'];

const videos = videoSources.map((src, index) => ({
  id: index + 1,
  src: src,
  title: `Corporate Event ${index + 1}`,
  category: categories[index % categories.length],
}));

const CorporateVideoCarousel: React.FC = () => {
...
export default CorporateVideoCarousel;
