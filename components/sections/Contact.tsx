...
const Contact: React.FC = () => {
  ...
  return (
    <SectionWrapper id="contact" className="pb-16">
      <div className="relative rounded-3xl overflow-hidden p-8 md:p-20 text-center border border-white/50 dark:border-white/10 bg-white/40 dark:bg-brand-dark-surface/40 backdrop-blur-xl shadow-xl shadow-stone-200/50 dark:shadow-black/50 transition-colors">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-brand-charcoal dark:text-white transition-colors">Let's Create Magic</h2>
            <p className="text-stone-600 dark:text-stone-300 mb-12 text-lg transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-left bg-white/80 dark:bg-brand-dark-surface/90 p-8 rounded-2xl border border-stone-100 dark:border-white/5 shadow-xl transition-colors">
                <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full bg-white dark:bg-white/5 border border-stone-200 dark:border-white/10 rounded-lg p-4 text-brand-charcoal dark:text-white focus:border-gold-500 focus:ring-1 focus:ring-gold-500 outline-none transition-all placeholder:text-stone-400" 
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select 
                            ...
                            className="w-full bg-white dark:bg-white/5 border border-stone-200 dark:border-white/10 rounded-lg p-4 text-brand-charcoal dark:text-white focus:border-gold-500 outline-none transition-all appearance-none cursor-pointer"
                        >
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full bg-white dark:bg-white/5 border border-stone-200 dark:border-white/10 rounded-lg p-4 text-brand-charcoal dark:text-white focus:border-gold-500 outline-none transition-all text-stone-500 dark:text-stone-400" 
                        />
                    </div>
                </div>
                ...
                <Button type="submit" className="w-full text-lg font-bold shadow-lg shadow-gold-500/20" size="lg" variant="secondary">Submit Inquiry</Button>
            </form>
