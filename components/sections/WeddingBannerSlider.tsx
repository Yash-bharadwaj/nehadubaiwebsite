...
// Import banner image
import banner1 from '../weddings/wedding-09.jpg';

const banners = [
  { image: banner1, title: 'Elegant Weddings', subtitle: 'Where Love Stories Begin' }
];

const WeddingBannerSlider: React.FC = () => {
        ...
        {banners.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all ${
              selectedIndex === index
                ? 'bg-rose-500 dark:bg-rose-400 w-8'
...
export default WeddingBannerSlider;
